...
- A **Base URL** — `https://ai-assistant.ai2s.org/` (or the URL shown on your API Key page)
...
1. **Sign in** at [https://ai-assistant.ai2s.org/](https://ai-assistant.ai2s.org/){target=_new} using your University of Arizona credentials.
...
If you run into issues, use the built-in support chat at [ai-assistant.ai2s.org](https://ai-assistant.ai2s.org/) (click the chat icon in the bottom-right corner) or reach out to the CyVerse team.
