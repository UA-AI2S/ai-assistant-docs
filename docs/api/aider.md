...
3. Replace the text `insert-default-model` with the AI Assistant model. For example, to use `phi4`, the model field would be set to `openai/phi4` or if you were using `nrp/phi4` model, the model field would be set to `openai/nrp/phi4`.
