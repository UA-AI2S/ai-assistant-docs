# Using Claude Code with the AI Assistant

Claude Code is Anthropic's official CLI coding assistant. The AI Assistant can serve as the backend for Claude Code, routing requests through its budget controls and guardrails to Anthropic Claude models hosted on AWS Bedrock.
...
!!! Note
    ...
    To obtain the AI Assistant Bedrock Base URL, simply substitute `/v1` with `/bedrock`.
